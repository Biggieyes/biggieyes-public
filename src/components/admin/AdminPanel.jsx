...
export default function AdminPanel({ open, onClose, data = {}, actions = {} }) {
  ...
  const healthTargets = React.useMemo(() => {
    const items = [
      { key: "MAIN", label: "Main Contract", address: ADDR.MAIN },
      { key: "MAIN2", label: "Main V2", address: ADDR.MAIN2 },
      { key: "COLLECTION_VRF", label: "Collection VRF", address: ADDR.COLLECTION_VRF },
      { key: "COLLECTION_PUBLIC", label: "Collection Public", address: ADDR.COLLECTION_PUBLIC },
      { key: "VRF_ROUTER", label: "VRF Router", address: ADDR.VRF_ROUTER },
      { key: "BIGGI", label: "BIGGI Token", address: ADDR.BIGGI },
      ...
      { key: "BUYBACK_AGENT", label: "Buyback Agent", address: ADDR.BUYBACK_AGENT },
      { key: "POLICY", label: "Policy", address: ADDR.POLICY },
      { key: "COLLECTION_REWARDS", label: "Collection Rewards", address: ADDR.COLLECTION_REWARDS },
      { key: "TOKEN_REWARDS", label: "Token Rewards", address: ADDR.TOKEN_REWARDS },
      { key: "NFT_REWARDS", label: "NFT Rewards", address: ADDR.NFT_REWARDS },
      { key: "DRIP_DISTRIBUTOR", label: "Drip Distributor", address: ADDR.DRIP_DISTRIBUTOR },
      { key: "DRIP_LM", label: "Drip LM", address: ADDR.DRIP_LM },
      { key: "LM", label: "Liquidity Manager", address: ADDR.LM },
      { key: "LIQUIDITY_VAULT", label: "Liquidity Vault", address: ADDR.LIQUIDITY_VAULT },
      { key: "COMMUNITY_CENTER", label: "Community Center", address: ADDR.COMMUNITY_CENTER },
      { key: "FACTORY", label: "DEX Factory", address: ADDR.FACTORY },
      { key: "ROUTER", label: "DEX Router", address: ADDR.ROUTER },
      { key: "PAIR", label: "DEX Pair", address: ADDR.PAIR },
      { key: "WETH", label: "Wrapped Native", address: ADDR.WETH },
      { key: "KEEPER_PROXY", label: "Keeper Proxy", address: ADDR.KEEPER_PROXY },
      { key: "KEEPER_ADDR", label: "Keeper Address", address: ADDR.KEEPER_ADDR },
      { key: "DRIP_KEEPER_PROXY", label: "Drip Keeper Proxy", address: ADDR.DRIP_KEEPER_PROXY },
      { key: "UPKEEP_PROXY", label: "Upkeep Proxy", address: ADDR.UPKEEP_PROXY },
      { key: "BIGGI_PRICE_ORACLE", label: "Price Oracle", address: ADDR.BIGGI_PRICE_ORACLE },
      { key: "MAIN_READER", label: "Main Reader", address: ADDR.MAIN_READER },
      { key: "COLLECTION_REWARDS_READER", label: "Collection Rewards Reader", address: ADDR.COLLECTION_REWARDS_READER },
      { key: "TOKEN_REWARDS_READER", label: "Token Rewards Reader", address: ADDR.TOKEN_REWARDS_READER },
      { key: "NFT_REWARDS_READER", label: "NFT Rewards Reader", address: ADDR.NFT_REWARDS_READER },
      { key: "RESERVE_READER", label: "Reserve Reader", address: ADDR.RESERVE_READER },
      { key: "BUYBACK_READER", label: "Buyback Reader", address: ADDR.BUYBACK_READER },
      { key: "LM_READER", label: "LM Reader", address: ADDR.LM_READER },
      { key: "BIGGI_TOKENOMICS_READER", label: "Tokenomics Reader", address: ADDR.BIGGI_TOKENOMICS_READER },
    ];
    const seen = new Set();
