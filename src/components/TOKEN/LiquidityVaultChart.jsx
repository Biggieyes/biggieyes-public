...
export default function LiquidityVaultChart({ data, height = 260 }) {
  ...
  return (
    <div className="liquidity-vault-chart" style={{ minHeight: safeHeight }}>
      <SimpleLineChart data={chartData} series={series} height={safeHeight} emptyLabel="No vault history yet." />
      {isSample ? (
        <div className="liquidity-vault-chart__hint">Sample data shown - provide vault history.</div>
      ) : null}
    </div>
  );
}
