...
function IconRowBase({ icons = [], onIconClick, className = "", style }) {
  ...
  if (userIndex > -1) {
    const [userIcon] = orderedIcons.splice(orderedIcons.findIndex(icon => icon?.key === "user"), 1);
  ...
  const baseBoxShadow =
    `0 0 0 1px rgba(0,0,0,.12), 0 6px 20px rgba(0,0,0,0.18)`;
  const glowSoft =
    `0 8px 30px rgba(255,232,0,0.18), 0 0 22px rgba(255,232,0,0.08)`;
  const glowStrong =
    `0 12px 36px rgba(255,232,0,0.26), 0 0 28px rgba(255,232,0,0.14)`;
  const activeInset =
        ...
        return (
          ...
          >
            <button
              ...
              onBlur={(e) => {
                const wrapper = e.currentTarget.parentElement;
                if (wrapper) wrapper.style.boxShadow = `${baseBoxShadow}, ${glowSoft}`;
              }}
            >
              <img
                ...
                draggable={false}
                onError={(e) => { e.currentTarget.src = transparentPx; }}
                style={{
                  display: "block",
                  width: width,
                  height: height,
                  ...
                  filter: "drop-shadow(0 6px 12px rgba(255,232,0,0.12)) drop-shadow(0 0 8px rgba(255,232,0,0.06))"
                }}
