...
const rpcUrl = getArg("--rpc", process.env.RPC_URL || process.env.VITE_RPC_URL_ACTIVE_CHAIN);
...
if (!rpcUrl) {
  console.error("Missing RPC URL. Use --rpc or set RPC_URL/VITE_RPC_URL_ACTIVE_CHAIN.");
  process.exit(1);
}
if (!privateKey) {
