...
Scope: submission surface (`src`, `docs`, app panels, runtime config).

Generated on: 2026-02-24  
Suggested refresh command:

```bash
rg -n --files-with-matches -S "Chainlink|VRF|VRFRouter|VRFConsumerBase|Coordinator|Upkeep|AutomationCompatible" src docs README.md
```
...
- [docs/FAQ.md](./FAQ.md)
- [docs/RISK_DISCLOSURE.md](./RISK_DISCLOSURE.md)
- [docs/ABI_INVENTORY.md](./ABI_INVENTORY.md)
...
- [src/shared/services/tokenomics/liquidity.reader.js](../src/shared/services/tokenomics/liquidity.reader.js)
