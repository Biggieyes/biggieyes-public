# Audit Notes - BiggiSeriesRegistry
...
## Security invariants
- One chapter-collection mapping must remain unique
- Registry updates cannot orphan active collections
- Read paths reflect latest committed links
