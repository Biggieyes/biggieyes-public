# Audit Notes - BiggiLiquidityManager

## Security invariants
- Only approved branch can call liquidity execution
- Reserve pull cannot exceed approved buckets
- LP token custody path is deterministic
