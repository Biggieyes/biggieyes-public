# Audit Notes - BiggiChapterController

## Security invariants
- Chapter transitions are valid and monotonic
- Only authorized controllers can mutate chapter state
- Reader-facing state remains coherent
