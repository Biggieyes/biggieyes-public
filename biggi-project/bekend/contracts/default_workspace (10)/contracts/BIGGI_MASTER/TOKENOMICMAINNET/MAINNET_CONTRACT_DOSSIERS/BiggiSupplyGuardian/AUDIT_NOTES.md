# Audit Notes - BiggiSupplyGuardian

## Security invariants
- Guardian cannot bypass hard cap
- Emergency path logs and limits are explicit
- Guardian cannot permanently block controller path
