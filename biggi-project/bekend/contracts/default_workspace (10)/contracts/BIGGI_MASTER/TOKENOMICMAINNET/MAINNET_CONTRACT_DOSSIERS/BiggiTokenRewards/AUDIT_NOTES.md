# Audit Notes - BiggiTokenRewards

## Security invariants
- Rewards inventory cannot go negative
- Claim accounting is non-reentrant and idempotent
- Refill path does not break cap invariants
