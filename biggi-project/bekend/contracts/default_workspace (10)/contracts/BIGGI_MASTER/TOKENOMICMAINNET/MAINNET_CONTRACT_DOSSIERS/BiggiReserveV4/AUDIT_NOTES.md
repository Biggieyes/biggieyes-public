# Audit Notes - BiggiReserveV4

## Security invariants
- Bucket math cannot underflow or double-count
- Only trusted actors can mutate reserve accounting
- LM pull permissions cannot leak
