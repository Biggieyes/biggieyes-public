# Audit Notes - BiggiPolicy

## Security invariants
- Daily quota reset math is stable across day boundaries
- Policy pause truly blocks buyback execution
- BPS and deadline bounds stay validated
