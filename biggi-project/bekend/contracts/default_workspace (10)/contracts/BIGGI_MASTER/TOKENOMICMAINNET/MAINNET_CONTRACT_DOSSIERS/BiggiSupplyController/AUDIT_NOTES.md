# Audit Notes - BiggiSupplyController

## Security invariants
- Cooldown and threshold logic prevents refill spam
- Pair alignment checks prevent wrong reserve source
- Circuit-breaker branch does not mint outside configured limits
