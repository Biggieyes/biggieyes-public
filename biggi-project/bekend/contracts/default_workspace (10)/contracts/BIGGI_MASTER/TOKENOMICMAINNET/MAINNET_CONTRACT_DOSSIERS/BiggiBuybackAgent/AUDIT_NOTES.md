# Audit Notes - BiggiBuybackAgent

## Security invariants
- Slippage/deadline policy is always enforced
- Daily quota cannot be bypassed via alternate entrypoint
- Forwarded BIGGI amounts match swap outputs
