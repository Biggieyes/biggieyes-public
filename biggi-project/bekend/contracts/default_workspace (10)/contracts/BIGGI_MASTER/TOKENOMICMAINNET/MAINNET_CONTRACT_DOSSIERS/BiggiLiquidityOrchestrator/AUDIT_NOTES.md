# Audit Notes - BiggiLiquidityOrchestrator

## Security invariants
- Do not run dual liquidity automation paths at once
- Trigger conditions cannot oscillate every block
- Quota/cooldown accounting is monotonic
