# Audit Notes - BiggiTicketHub

## Security invariants
- No hard global ticket ceiling unless explicitly configured
- Sale accounting cannot be forged by untrusted caller
- Metadata URI flow stays consistent
