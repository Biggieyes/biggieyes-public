# Audit Notes - BiggiDripDistributor

## Security invariants
- availableTokens never drifts above real token balance for payout
- Collection authorization gates claims
- Historical seeding cannot be replayed
