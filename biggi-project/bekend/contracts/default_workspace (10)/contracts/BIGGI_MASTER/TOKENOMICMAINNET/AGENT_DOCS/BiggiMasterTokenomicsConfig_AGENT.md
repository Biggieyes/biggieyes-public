# Agent documentation — BiggiMasterTokenomicsConfig.sol

**Role:** Tokenomics address registry

## Purpose
Stores canonical addresses for tokenomics branch contracts for agents/scripts/UI.

## Top-level declarations
- Contracts/libraries: BiggiMasterTokenomicsConfig
