# Agent documentation — BiggiNftRewardsReader.sol

**Role:** NFT rewards reader

## Purpose
Read-only adapter over NFT rewards contract and NFT metadata.

## Top-level declarations
- Contracts/libraries: BiggiNftRewardsReader
- Interfaces in file: IBiggiNftRewards
