# Agent documentation — BiggiLiquidityOrchestrator.sol

**Role:** Liquidity command orchestrator

## Purpose
Ownable coordination layer over reserve, liquidity manager, and vault actions.

## Top-level declarations
- Contracts/libraries: BiggiLiquidityOrchestrator
- Interfaces in file: IBiggiReserveOrch, IBiggiLiquidityManagerOrch, ILiquidityVaultOrch
