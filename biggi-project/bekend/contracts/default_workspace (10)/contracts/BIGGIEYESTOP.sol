    ...
    ReentrancyGuard
{
    ...
    uint256 public constant MAX_PRESALE_TICKETS = 50;
    ...
    /// @notice Presale mint (payable → split do poolu + DEV + LIQUIDITY)
    ...
    /// @notice Nastaví cílový kontrakt na likviditu + podíl v BPS (např. 500 = 5%)
