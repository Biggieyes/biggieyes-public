...
if (!process.env.PRIVATE_KEY) {
  throw new Error("OWNER_PRIVATE_KEY is required for ModeratorCenterV2 configuration");
}
...
process.env.MODERATOR_V2_CONFIG_EXECUTE = execute ? "1" : "0";
process.argv = [
  process.argv[0],
  "hardhat",
  "run",
  ...
  "scripts/master/configureModeratorV2.js",
  "--network",
  "polygon",
];
