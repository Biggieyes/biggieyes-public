 ...
 * @dev NOT USED BY BIGGI PRODUCTION. BIGGI deploys the paused, explicitly-owned
 *      BiggiCREAutomationReceiver through `npm run deploy:master:cre-receiver:polygon`.
 *      This generated contract remains only as upstream template reference.
 *
