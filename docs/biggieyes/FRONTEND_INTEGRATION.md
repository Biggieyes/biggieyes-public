...
Batch reads use the official BIGGIEYES Polygon mainnet `MULTICALL2` utility at `0x70bc315E4E5548e54F358Abf4515C1bB1551687b`. The frontend uses this contract through `src/shared/utils/multicall.js` to aggregate multiple read calls into one RPC request for dashboards, rewards panels, liquidity panels, and tokenomics views.
